        ...
        <main className="flex flex-col gap-[120px] mt-20">
          ...
          <CaseStudySection title="The problem">
            <div className="flex flex-col gap-5 max-w-[710px]">
              ...
              <div className="flex flex-col items-start">
                <div className="relative bg-[#ededed] rounded-[8px] px-4 py-2 max-w-[467px]">
                  <p className="font-satoshi text-[14px] font-medium leading-[1.25] text-[#656565]">
                    We really want a new site for our coffee brand. We know that WeMakeWebsites
                    makes shopify sites. We don't want our site to look like a Shopify site though.
                    We want something that represents our brand.
                  </p>
                  <svg
              ...
              <div className="flex justify-end">
                <div className="relative bg-[#0090ff] rounded-[8px] px-4 py-2 max-w-[467px]">
                  <p className="font-satoshi text-[14px] font-medium leading-[1.25] text-white">
                    No problem. What I'll be doing is understanding your brand, and creating a
                    design that represents it. I also wouldn't want it to look like everything else.
                  </p>
                  <svg
              ...
              <div className="flex flex-col items-start">
                <div className="relative bg-[#ededed] rounded-[8px] px-4 py-2 max-w-[467px]">
                  <p className="font-satoshi text-[14px] font-medium leading-[1.25] text-[#656565]">
                    We make coffee and want to highlight our process. We want to show off our team.
                    We want to sell our freshly roasted coffee. Can you capture all of this in a
                    your design?
                  </p>
                  <svg
                    className="absolute -bottom-[6px] left-[16px]"
          ...
          <CaseStudySection title="Understanding the client">
            <div className="grid gap-10 lg:grid-cols-2">
              <div className="space-y-4 text-[14px] font-medium leading-[1.5] text-[#656565]">
                ...
                <p>
                  I quickly had to understand the brand, the product, and the people behind it.
                  Union Roasted was a coffee I'd purchased myself in stores, so it was a really fun
                ...
                <p>
                  They made it clear that they wanted to show off their process, the quality of
                  their beans, and the partnerships with the farmers. This gave me some great
                  opportunities to show off my design skills and create a really unique site that
                  stood out from the typical Shopify sites.
                </p>
              </div>
          ...
          <CaseStudySection title="End notes">
            <div className="max-w-[588px] space-y-4 text-[14px] font-medium leading-[1.5] text-[#656565]">
              <p>
                It's been a while since I worked on this site. So sadly a lot of the materials such
                as wireframes, and earlier work aren't available to me anymore. The client however,
                was incredibly happy with what was delivered. They fully expected a generic Shopify
                site, and they got an incredibly unique design that at the time matched them
                perfectly.
                <br />
                <br />

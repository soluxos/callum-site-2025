...
export default async function AcquiaUnificationCaseStudy() {
      ...
      <>
        <CaseStudyFullHero
          ...
          metaItems={[
            ...
            { label: "Outcome", value: "A product that could house all existing Acquia products" },
            {
              label: "Deliverables",
              value:
          ...
          <main className="flex flex-col gap-[120px] mt-20">
                ...
                items={[
                  {
                    ...
                    description:
                      "Taking multiple products and unifying the experience between them.",
                    media: (
                      <img
                        alt="Redesigned UI"
            ...
            <CaseStudySection title="What it looks like">
              <CaseStudySlider
                images={[
                  {
                    src: "/images/case-studies/acquia-unification/slide-1.png",
                    alt: "Acquia Prospero redesigned UI",
                  },
                  {
                    src: "/images/case-studies/acquia-unification/slide-2.png",
                    alt: "Acquia Prospero user testing",
                  },
                  {
                    src: "/images/case-studies/acquia-unification/slide-3.png",
                    alt: "Acquia Prospero product requirements",
                  },
                  {
                    src: "/images/case-studies/acquia-unification/slide-4.png",
                    alt: "Acquia Prospero shipped MVP",
                  },
                  {
                    src: "/images/case-studies/acquia-unification/slide-5.png",
                    alt: "Acquia Prospero shipped MVP",
                  },
                ]}
              />
            ...
            <STARBreakdown caseStudyId="acquia-unification" />          </main>
        </CaseStudyLayout>
      </>
    </PasswordGate>
  );

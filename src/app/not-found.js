...
export default function NotFound() {
  return (
    <div className="bg-[#0A0D08] font-satoshi flex flex-col items-center justify-center min-h-screen w-full">
      {/* 404 Section */}
      <section className="flex w-full h-screen relative flex-col items-center justify-center">

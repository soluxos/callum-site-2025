    ...
    <>
      <div className="nav-block fixed top-5 left-10 md:left-15 lg:left-20 transform z-50 flex items-center gap-[10px] max-w-[calc(100vw - 48px)]">
        <motion.div
          ...
          className="bg-[#11160E] h-12 rounded-[8px] flex items-center gap-4 w-auto relative max-w-[calc(100vw - 48px)]"
        >
          ...
          <nav className="flex items-center">
            ...
            <div className="about flex flex-col items-start relative cursor-pointer px-4 py-[10px]">
              ...
              <p className="font-departure-mono uppercase text-[12px] flex gap-1">
                <span className="text-[#FF2B00]">✦</span> About
              </p>
            </div>
            <div className="separator w-[1px] h-6 bg-[rgba(255,255,255,0.1)]" />
            <div className="flex flex-col items-start px-4 py-[10px]">
              ...
              <a className="font-departure-mono uppercase text-[12px] flex gap-1">
                <span className="text-[#FF2B00]">♥</span> Contact
              </a>
            </div>
            <div className="separator w-[1px] h-6 bg-[rgba(255,255,255,0.1)]" />
